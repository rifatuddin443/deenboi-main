    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md slide-up">
        <CardHeader className="text-center pb-2">
          <CardTitle className="text-3xl font-display">Barakah Books</CardTitle>
          ...
          <Tabs defaultValue="login">
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground">New accounts are assigned the Seller role by default. Contact admin to change roles.</p>
                <Button type="submit" className="w-full" disabled={loading}>
